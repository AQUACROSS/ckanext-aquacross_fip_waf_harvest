...
from base import FIP_SpatialHarvester, guess_standard

log = logging.getLogger(__name__)


class Aquacross_FIP_WAF_Harvest(FIP_SpatialHarvester, SingletonPlugin):
    '''
    ...
    def info(self):
        return {
                'name': 'aquacross_fip_waf_harvest',
                'title': 'FIP Web Accessible Folder (WAF) harvest',
                'description': 'Web Accessible Folder (WAF) spatial harvester for the Freshwater Information Platform'
               }
